-- ============================================================================
-- TEST 4 — 011_collection_folders.sql contract:
--   * collection_folders exists with collection_id + self-referential parent_id
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_name = 'collection_folders' AND column_name = 'id'
  ) THEN RAISE EXCEPTION 'FAIL 4.1a: collection_folders.id missing'; END IF;
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'collection_folders' AND column_name = 'parent_id'
  ) THEN RAISE EXCEPTION 'FAIL 4.1b: collection_folders.parent_id missing'; END IF;
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
  ...
  RAISE NOTICE 'PASS 4.1: collection_folders schema present';
END $$;
...
DECLARE n int;
BEGIN
  INSERT INTO collection_folders (id, collection_id, name) VALUES
    ('00000000-0000-0000-0000-000000000040', '00000000-0000-0000-0000-000000000021', 'Customer');
  INSERT INTO collection_folders (id, collection_id, parent_id, name) VALUES
  ...
  SELECT count(*) INTO n FROM collection_folders
...
BEGIN
  ...
  DELETE FROM collection_folders WHERE id = '00000000-0000-0000-0000-000000000041';
  SELECT count(*) INTO n FROM api_requests
    WHERE folder_id = '00000000-0000-0000-0000-000000000041';
...
DECLARE n int;
BEGIN
  DELETE FROM collection_folders WHERE id = '00000000-0000-0000-0000-000000000040';
  SELECT count(*) INTO n FROM collection_folders
    WHERE collection_id = '00000000-0000-0000-0000-000000000021';
...
BEGIN
  ...
  UPDATE collection_folders SET name = 'Renamed by Editor'
